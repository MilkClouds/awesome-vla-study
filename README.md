...
|---|-------|------|-----------|
| 1 | **RT-1: Robotics Transformer** — Brohan et al. (2022) | [2212.06817](https://arxiv.org/abs/2212.06817) · [project](https://robotics-transformer1.github.io/) · [code](https://github.com/google-research/robotics_transformer) | First large-scale Robotics Transformer (no VLM) |
| 2 | **RT-2: Vision-Language-Action Models** — Brohan et al. (2023) | [2307.15818](https://arxiv.org/abs/2307.15818) · [project](https://robotics-transformer2.github.io/) | VLM backbone → VLA paradigm |
| 3 | **Octo** — Ghosh et al. (2024) | [2405.12213](https://arxiv.org/abs/2405.12213) · [project](https://octo-models.github.io/) · [code](https://github.com/octo-models/octo) | Lightweight open-source diffusion policy (no VLM) |
| 4 | **OpenVLA** — Kim et al. (2024) | [2406.09246](https://arxiv.org/abs/2406.09246) · [project](https://openvla.github.io/) · [code](https://github.com/openvla/openvla) | First open-source VLM-based VLA |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 5 | **Behavior Transformers (BeT)** — Shafiullah et al. (2022) | [2206.11251](https://arxiv.org/abs/2206.11251) · [code](https://github.com/notmahi/bet) | Multimodal action discretization, k-means + offset |
| 6 | **Diffusion Policy** — Chi et al. (2023) | [2303.04137](https://arxiv.org/abs/2303.04137) · [project](https://diffusion-policy.cs.columbia.edu/) · [code](https://github.com/real-stanford/diffusion_policy) | Diffusion for robot control, action chunking |
| 7 | **ACT/ALOHA** — Zhao et al. (2023) | [2304.13705](https://arxiv.org/abs/2304.13705) · [project](https://tonyzhaozh.github.io/aloha/) · [code](https://github.com/tonyzhaozh/act) | Action Chunking Transformer, CVAE, bimanual |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 8 | **CogACT** — Li et al. (2024) | [2411.19650](https://arxiv.org/abs/2411.19650) · [project](https://cogact.github.io/) | VLM + DiT action head, 55%↑ vs OpenVLA on real robot |
| 9 | **GR00T N1** — Bjorck et al. (2025) | [2503.14734](https://arxiv.org/abs/2503.14734) · [code](https://github.com/NVIDIA/Isaac-GR00T) | 2B diffusion transformer, whole-body humanoid control |
| 10 | **X-VLA** — Zheng et al. (2025) | [2510.10274](https://arxiv.org/abs/2510.10274) · [project](https://thu-air-dream.github.io/X-VLA/) · [code](https://github.com/2toinf/X-VLA) | Soft prompts for cross-embodiment, Florence-Large + flow matching |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 11 | **π0** — Black et al. (2024) | [2410.24164](https://arxiv.org/abs/2410.24164) · [project](https://www.physicalintelligence.company/blog/pi0) · [code](https://github.com/Physical-Intelligence/openpi) | Flow matching + action expert accessing VLM intermediate features |
| 12 | **InternVLA-M1** — Chen et al. (2025) | [2510.13778](https://arxiv.org/abs/2510.13778) · [project](https://internrobotics.github.io/internvla-m1.github.io/) · [code](https://github.com/InternRobotics/InternVLA-M1) | Spatial grounding → action generation, AR-based |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 13 | **Open X-Embodiment (OXE)** — Open X-Embodiment Collaboration (2023) | [2310.08864](https://arxiv.org/abs/2310.08864) · [project](https://robotics-transformer-x.github.io/) | 1M+ trajectories, 22 embodiments, standardized data format |
| 14 | **AgiBot World** — Bu et al. (2025) | [2503.06669](https://arxiv.org/abs/2503.06669) · [project](https://agibot-world.com/) | 1M+ trajectories, 217 tasks, 100+ scenarios |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 15 | **UMI** — Chi et al. (2024) | [2402.10329](https://arxiv.org/abs/2402.10329) · [project](https://umi-gripper.github.io/) · [code](https://github.com/real-stanford/universal_manipulation_interface) | Robot-free SE(3) data collection via handheld gripper |
| 16 | **VITRA** — Li et al. (2025) | [2510.21571](https://arxiv.org/abs/2510.21571) · [project](https://microsoft.github.io/VITRA/) | Human video → VLA training data (1M episodes from Ego4D) |
| 17 | **Human to Robot Transfer** — Kareer et al. (2025) | [2512.22414](https://arxiv.org/abs/2512.22414) · [project](https://www.pi.website/research/human_to_robot) | Human video → robot transfer emerges with VLA scaling |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 18 | **SmolVLA** — Shukor et al. (2025) | [2506.01844](https://arxiv.org/abs/2506.01844) · [code](https://github.com/huggingface/lerobot) | 450M params (~1/7 of π0), model compression + async inference |
| 19 | **RTC** — Black et al. (2025) | [2506.07339](https://arxiv.org/abs/2506.07339) · [project](https://www.pi.website/research/real_time_chunking) | Async inference — freezing + inpainting, no retraining needed |
...
| 21 | **Fast-in-Slow** — Chen et al. (2025) | [2506.01953](https://arxiv.org/abs/2506.01953) · [project](https://fast-in-slow.github.io/) | Integrated dual-system, end-to-end trainable |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 22 | **HIL-SERL** — Luo et al. (2024) | [2410.21845](https://arxiv.org/abs/2410.21845) · [project](https://hil-serl.github.io/) · [code](https://github.com/rail-berkeley/hil-serl) | Human-in-the-loop RL, 1-2.5h real-world training, near-perfect success |
| 23 | **SimpleVLA-RL** — Li et al. (2025) | [2509.09674](https://arxiv.org/abs/2509.09674) · [code](https://github.com/PRIME-RL/SimpleVLA-RL) | RL fine-tuning for AR-based VLA, 99.1% LIBERO SOTA |
| 24 | **π\*0.6 / Recap** — Physical Intelligence (2025) | [2511.14759](https://arxiv.org/abs/2511.14759) · [project](https://www.pi.website/blog/pistar06) | RL for flow-based VLA, 3-stage pipeline, 90%+ on real tasks |
...
| # | Paper | Link | Key Topic |
|---|-------|------|-----------|
| 25 | **CoT-VLA** — Zhao et al. (2025) | [2503.22020](https://arxiv.org/abs/2503.22020) · [project](https://cot-vla.github.io/) | Visual chain-of-thought reasoning (future image prediction) before action |
| 26 | **UniVLA** — Wang et al. (2025) | [2506.19850](https://arxiv.org/abs/2506.19850) · [code](https://github.com/baaivision/UniVLA) | Unified AR VLA with world modeling as training objective |
| 27 | **Cosmos Policy** — Kim et al. (2026) | [2601.16163](https://arxiv.org/abs/2601.16163) · [project](https://research.nvidia.com/labs/dir/cosmos-policy/) | Video foundation model → robot policy, LIBERO 98.5% |
